...
@Log public class WorkerDAO implements DAO<Worker> {
    ...
    private static final String QUERY_BY_DNI = "Select * from trabajador where dni=?";
    private final String UPDATE_BY_ID = "Update trabajador where id=? ";
    ...
    public Worker update(Worker worker) {
        ...
        try {
            ...
            preparedStatement.setString(3, String.valueOf(out.getFrom()));
     ...
     * @return
     */
    public static Worker getWorkerByDNI(String dni) {
    ...
    public List<Worker> getAllOrderByFrom(){
        ...
        /* Make implementation here ...  */
        try {
            Statement st = JDBCUtils.getConn().createStatement();
